  ...
  return (
    <>
      <PageHeader className="mb-10">
        ...
        <PageHeaderDescription>
          Education has been a strong foundation in my journey through technology. Pursuing a B.Tech in Computer Science and Engineering (Artificial Intelligence & Machine Learning) at VIT Bhopal University has strengthened my understanding of computer science, software development, and emerging technologies.
        </PageHeaderDescription>
